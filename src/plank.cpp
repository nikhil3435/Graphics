...
Plank::Plank(float x, float y, color_t color) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 180, vertex_buffer_data, COLOR_GREEN, GL_FILL);
    this->object2 = create3DObject(GL_TRIANGLES, 6 ,vertex_buffer_data_2,COLOR_GREEN, GL_FILL);
}
